...
import { usePlatformMovies } from "../../hooks/usePlatformMovies";
...
function PlatformResults() {
  ...
  const id = providerId ? Number(providerId) : 0;
  ...
  return (
    <div className="px-6 pb-12 pt-6 md:px-12">
      <SEO title={`${name} Movies`} description={`Browse movies available on ${name}.`} />
