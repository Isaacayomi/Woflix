...
function NavIcon({ icon }: { icon: string }) {
  switch (icon) {
    ...
    case "bookmarks":
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 17 20" fill="currentColor">
...
function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around bg-semiDarkBlue px-4 py-3 lg:sticky lg:top-0 lg:z-[9999] lg:h-screen lg:w-[6rem] lg:flex-shrink-0 lg:flex-col lg:justify-between lg:py-8">
      <img
